          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5 mt-4 shadow-xl px-5 rounded-[20px] py-5 w-full">
            ...
            <div className="flex gap-5 flex-col md:flex-row">
              <div className="flex flex-col items-start gap-2">
                ...
                <input
                  ...
                  className="border-2 border-gray-100 rounded-xl p-2 bg-gray-100 text-gray-500 focus:outline-none focus:border-2 focus:border-solid focus:border-black transtion duration-100"
                />
              </div>
            ...
            <div className="flex flex-col items-start gap-2">
              ...
              <select
                ...
                className="border-2 border-gray-100 rounded-xl p-2 bg-gray-100 text-gray-500 focus:outline-none focus:border-2 focus:border-solid focus:border-black transtion duration-100 w-[95%]"
              >
            ...
            <div className="flex flex-col items-start gap-2">
              ...
              <input
                ...
                className="border-2 border-gray-100 rounded-xl p-2 bg-gray-100 focus:border-2 focus:border-solid focus:border-black transtion duration-100 text-gray-500 w-[95%] focus:outline-none"
              />
            </div>
            ...
            <div className="flex flex-col items-start gap-2">
              ...
              <input
                ...
                className="border-2 border-gray-100 rounded-xl p-2 bg-gray-100 text-gray-500 w-[95%] focus:outline-none focus:border-2 focus:border-solid focus:border-black transtion duration-100"
              />
            </div>
            ...
            <div className="flex flex-col items-start gap-2">
              ...
              <textarea
                ...
                className="border-2 border-gray-100 rounded-2xl p-2 w-[95%] h-16 bg-transparent focus:border-2 focus:border-solid focus:border-black transtion duration-100"
              ></textarea>
            </div>
